...
export const apiSlice = createApi({
    ...
    tagTypes: ["User", "Auth", "SystemAdmins", "AdminRoles", "AdminPermissions", "Industries", "SubscriptionPlans", "SubscriptionFeatureTypes", "Subscriptions", "Organizations", "MoneyReceivingMethods", "Positions"],
