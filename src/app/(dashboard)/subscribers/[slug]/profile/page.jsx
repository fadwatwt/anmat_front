            ...
            <div className={"w-full flex flex-col items-center md:gap-6 xl:gap-4 gap-8 h-full"}>
                        ...
                        <div className={" rounded-2xl p-4 border border-status-border flex bg-surface"}>
                            <div
                                ...
                                <div className={"w-full flex md:flex-row flex-col gap-4 "}>
                                    <div className={`flex flex-col gap-4 w-56  ${i18n.language === "ar" ? "md:border-l-2 " : "md:border-r-2 "} border-status-border`}>
                                        <div className={"name-profile flex items-center gap-1"}>
                                            ...
                                            <p className={"text-cell-primary text-sm font-medium "}>{subscriber?.name || "N/A"}</p>
                                        </div>
                                        <div className={"name-profile flex items-center gap-1"}>
                                    ...
                                    <div className={"flex flex-col gap-4 flex-1"}>
                                        <div className={"name-profile flex items-center gap-1"}>
                                            ...
                                            <p className={"text-cell-primary text-sm font-medium"}>{subscriber?.email || "N/A"}</p>
                                        </div>
                                        <div className={"name-profile flex items-center gap-1"}>
                            ...
                            <div className={"w-full flex md:flex-row flex-col gap-4 "}>
                                <div className={`flex flex-col gap-4 w-56  ${i18n.language === "ar" ? "md:border-l-2 " : "md:border-r-2 "} border-status-border`}>
                                    <div className={"name-profile flex items-center gap-1"}>
                                        ...
                                        <p className={"text-cell-primary text-sm font-medium "}>{subscriber?.organization?.name || "N/A"}</p>
                                    </div>
                                    <div className={"name-profile flex items-center gap-1"}>
                                ...
                                <div className={"flex flex-col gap-4 flex-1"}>
                                    <div className={"name-profile flex items-center gap-1 "}>
                                        <RiMapPinLine size={18} className={"text-cell-secondary text-sm"} />
                                        <span className={"text-cell-secondary text-sm"}>{t("Country")}:</span>
                                        <p className={"text-cell-primary text-sm font-medium"}>{subscriber?.organization?.country || "N/A"}</p>
                                    </div>
                                    <div className={"name-profile flex items-center gap-1"}>
                                    ...
                                    <div className={"name-profile flex items-center gap-1"}>
                                        ...
                                        <p className={"text-cell-primary text-sm font-medium"}>{subscriber?.organization?.email || "N/A"}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className={"flex gap-6 md:flex-row flex-col items-start w-full md:px-10 px-2 justify-between"}>
                    <div className={"md:w-full w-full flex flex-col gap-4 items-center h-full"}>
                        <div className={"bg-surface rounded-2xl p-4 gap-6 md:flex-1 flex flex-col items-center w-full p-5"}>
                            <div className={"w-full border border-status-border rounded-md flex flex-col gap-4 p-4"}>
                                <div className="flex justify-between items-center">
                                    <h3 className={"text-lg font-s text-cell-primary"}>{t("Subscription Information")}</h3>
                                ...
                                <div className={"w-full grid grid-flow-col grid-rows-2 gap-3 "}>
                                    ...
                                    <div className={"name-profile flex items-center gap-1"}>
                                        <RiBuilding2Line size={18} className={"text-cell-secondary text-sm"} />
                                    ...
                                    <div className={"name-profile flex items-center gap-1"}>
                                        <RiCheckboxLine size={18} className={"text-cell-secondary text-sm"} />
                                        <span className={"text-cell-secondary text-sm"}>{t("Features")}:</span>
                                        <div className={"flex items-center gap-1 flex-wrap"}>
                                            {
                                                lastActiveSubscription?.plan_id?.features?.length > 0 ? (
                                                    lastActiveSubscription.plan_id.features.map((feature, index) => (
                                                        <p key={index} className={"bg-badge-bg border border-status-border py-1 px-2 rounded-xl text-badge-text text-sm font-medium"}>
                                    ...
                                    <div className={"name-profile flex items-center gap-1"}>
                                        <RiCalendarLine size={18} className={"text-cell-secondary text-sm"} />
                                    ...
                                    <div className={"name-profile flex items-center gap-1"}>
                                        <RiWalletLine size={18} className={"text-cell-secondary text-sm"} />
                                    ...
                                    <div className={"name-profile flex items-center gap-1"}>
                                        <RiDiscountPercentLine size={18} className={"text-cell-secondary text-sm"} />
