    ...
    return (
        <div className="flex items-center gap-4 w-full group">
            <div className="w-24 shrink-0">
                <p className="text-sm font-semibold text-table-title truncate">{name}</p>
            </div>

            <div className="flex-1 flex flex-col gap-1">
                <div className="w-full bg-status-bg border border-status-border h-2 rounded-full overflow-hidden">
                    <div
