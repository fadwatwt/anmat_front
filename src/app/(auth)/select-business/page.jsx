    ...
    const TYPES = [
        {
            ...
            icon: <RiMacLine className="text-md" />
        },
        {
            title: 'Product Management',
            icon: <RiBox2Line className="text-md" />
        },
        {
            title: 'Marketing',
            icon: <RiUserSmileLine className="text-md" />
        },
        {
            title: 'Design',
            icon: <RiPaletteLine className="text-md" />
        },
        {
            title: 'Project Management',
            icon: <RiCalendarTodoLine className="text-md" />
        },
        {
            title: 'Operations',
            icon: <RiSettings4Line className="text-md" />
        },
        {
            title: 'IT Support',
            icon: <RiErrorWarningLine className="text-md" />
        },
        {
            title: 'Other',
            icon: <RiApps2AiLine className="text-md" />
        }
    ];
