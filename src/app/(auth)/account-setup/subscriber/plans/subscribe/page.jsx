...
function Page({
    ...
    return (
        <div className={"w-full max-h-full flex justify-start items-start overflow-hidden"}>
            <div className={"w-1/3 bg-white flex justify-start px-8 py-8 h-full overflow-y-auto"}>
                <div className={"flex flex-col gap-4 w-full"}>
                    <Link href={"/account-setup/subscriber/plans"}
                          className={"text-primary-500 text-sm cursor-pointer font-bold "}>
                        Back
                    </Link>
                    <div className={"flex flex-col gap-4 w-full"}>
                        ...
                        <div className={"w-full flex justify-between items-center"}>
                            <div
                                className={"border border-2 border-primary-500 rounded-xl py-2 px-4  w-[48%] flex justify-between items-center"}>
                            ...
                            <div
                                className={"border  border-gray-500 rounded-xl py-2 px-4  w-[48%] flex justify-between items-center"}>
                                <div className={"flex gap-3 items-center"}>
                                    <div className={"flex items-start mt-1 self-start"}>
                                        <input type={"radio"} name={"payment1"} className={""}/>
                                    </div>
                        ...
                        <div
                            className={"w-full p-2 flex justify-center items-center bg-primary-100 rounded-lg text-md text-primary-500 cursor-pointer"}>
            ...
            <div className={"w-2/3 flex flex-col justify-start items-start px-16 pt-28 gap-10"}>
                ...
                <div
                    className={"w-full p-5 rounded-lg flex items-center justify-between bg-white border border gap-3"}>
                    <div
