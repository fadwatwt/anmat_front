...
export const metadata = {
    ...
    title: {
        default: "أنماط | Anmaat - نظام إدارة المؤسسات",
        template: "%s | أنماط Anmaat",
    },
    ...
    keywords: ["أنماط", "Anmaat", "نظام إدارة", "management dashboard", "ERP", "team collaboration", "project management", "إدارة المشاريع", "إدارة الفرق"],
    authors: [{ name: "Anmaat" }],
    creator: "Anmaat",
    publisher: "Anmaat",
    robots: {
    ...
    openGraph: {
        ...
        siteName: "أنماط | Anmaat",
        title: "أنماط | Anmaat - نظام إدارة المؤسسات",
        description: "منصة متكاملة لإدارة المؤسسات والفرق — مشاريع، مهام، اجتماعات، تحليلات، وتواصل فوري.",
        url: siteUrl,
        images: [{ url: "/images/logoBlue.png", width: 512, height: 512, alt: "Anmaat Logo" }],
    },
    twitter: {
    ...
    other: {
        "application-name": "أنماط Anmaat",
        "apple-mobile-web-app-title": "أنماط Anmaat",
