import dashboardImage from "../../assets/images/LandingPage/dashboardImage.png"
import logoBlue from "../../assets/images/LandingPage/logoBlue.png"
import chart1 from "../../assets/images/LandingPage/chart1.png"
import pioChart from "../../assets/images/LandingPage/pioChart.png"
import notificationsImage from "../../assets/images/LandingPage/notifications.png"
import fileInputImage from "../../assets/images/LandingPage/fileInputImage.png"
import followAndUnFollowModalImage from "../../assets/images/LandingPage/followAndUnfollowModalImage.png"
import projectDetailsImage from "../../assets/images/LandingPage/projectDetailsImage.png"
import taskStagesImage from "../../assets/images/LandingPage/taskStagesImage.png"
import companyImage1 from "../../assets/images/LandingPage/companyImag1.png"
import arrowSwitchImage from "../../assets/images/LandingPage/arrowSwitchImage.png"
import company1Image from "../../assets/images/LandingPage/Companys/company1.png"
import company2Image from "../../assets/images/LandingPage/Companys/company2.png"
import company3Image from "../../assets/images/LandingPage/Companys/company3.png"
import company4Image from "../../assets/images/LandingPage/Companys/company4.png"
import company5Image from "../../assets/images/LandingPage/Companys/company5.png"
...
import Switch from "../Setting/Tabs/NotificationsTab/Switch.jsx";
        ...
        <div className={"flex flex-col w-full items-center"}>
            <div
                ...
                <div className={"flex flex-col gap-8 max-w-[87rem] w-[87rem]"}>
                    ...
                    <div className={"flex justify-center w-full"}>
                        <img src={dashboardImage} alt={"dashboard image"} className={"w-8/12"}/>
                    </div>
                </div>
            </div>
            <div className={"max-w-[87rem] w-[87rem] flex flex-col justify-center items-center gap-10"}>
                ...
                <div className={" w-full grid grid-cols-2 gap-6"}>
                    <div className={"bg-gradient-to-tr from-[#FED2CC] to-[#FFDFDB80] py-0 w-full rounded-xl"}>
                        <div className={"flex flex-col gap-2 items-start "}>
                            ...
                            <div className={"relative w-full h-72 flex justify-end pr-10 py-0 overflow-hidden"}>
                                <img src={pioChart} alt={"chart1"} className={"w-72 absolute right-10 top-11"}/>
                                <img src={chart1} alt={"chart1"} className={"w-72 absolute right-64 -top-4"}/>
                            </div>
                        </div>
                    </div>
                    <div className={"bg-gradient-to-tr from-[#D2C3FE] to-[#E2D6FF80] w-full rounded-md"}>
                        <div className={"flex flex-col gap-2 items-start "}>
                            ...
                            <div className={"relative w-full h-72 flex justify-center pr-10 py-0 overflow-hidden"}>
                                <img src={notificationsImage} alt={"notifications image"} className={"w-96 absolute -top-3"}/>
                            </div>
                        </div>
                    </div>
                    <div className={"bg-gradient-to-tr from-[#BFDDD1] to-[#D6EAE180] w-full rounded-xl"}>
                        <div className={"flex flex-col gap-2 items-start "}>
                            ...
                            <div className={"relative w-full h-72 flex justify-end pr-10 py-0 overflow-hidden"}>
                                <img src={fileInputImage} alt={"chart1"} className={"w-72 absolute right-64 -top-4"}/>
                                <img src={followAndUnFollowModalImage} alt={"chart1"} className={"w-72 absolute right-10 top-11"}/>
                            </div>
                        </div>
                    </div>
                    <div className={"bg-gradient-to-tr from-[#C7D5FF] to-[#E5EBFF80] w-full rounded-xl"}>
                        <div className={"flex flex-col gap-2 items-start "}>
                            ...
                            <div className={"relative w-full h-72 flex justify-end pr-10 py-0 overflow-hidden"}>
                                <img src={taskStagesImage} alt={"chart1"}
                                     className={"w-96 absolute right-52 top-11"}/>
                                <img src={projectDetailsImage} alt={"chart1"}
                ...
                <div className={"bg-primary-700 w-full rounded-xl flex items-start justify-between gap-3"}>
                    ...
                    <div className={"py-8"}>
                        <img src={companyImage1} alt={"company"} className={" max-w-[480px]"}/>
                    </div>
                </div>
                <div className={"flex flex-col w-full "}>
                    <div className={"flex flex-col py-10 gap-12"}>
                        ...
                        <div className={"flex items-center justify-center gap-3 relative"}>
                            <p>Pay Monthly </p>
                            <Switch
                                handleToggle={() => setIsOnSwitch(!isOnSwitch)}
                                isOn={isOnSwitch}
                            />
                            <p>Pay Yearly</p>
                            <img src={arrowSwitchImage} alt={"arrow"} className={"absolute w-[185px] h-[87px] right-[24rem] -top-7"} />
                        </div>
                ...
                <div className={"flex flex-col gap-5 justify-center items-center"}>
                    ...
                    <div className={"flex items-center max-w-full px-10 gap-8"}>
                        <img src={company1Image} alt={""} className={"w-44"} />
                        <img src={company2Image} alt={""} className={"w-44"} />
                        <img src={company3Image} alt={""} className={"w-44"} />
                        <img src={company4Image} alt={""} className={"w-44"} />
                        <img src={company5Image} alt={""} className={"w-44"} />
                    </div>
                </div>
                        ...
                        <div className={"flex flex-col items-center gap-5 pt-10 pb-16"}>
                            <div className={"flex relative justify-center"}>
                                <div className={"p-1 rounded-full w-13 h-13 "}>
                                    <img src={user1Image} alt={"user1"} className={"rounded-full w-10 h-10"}/>
                                </div>
                                <div className={"p-1 rounded-full w-13 h-13 absolute -top-1"}>
                                    <img src={user2Image} alt={"user2"} className={"rounded-full w-10 h-10"}/>
                                </div>
                                <div className={"p-1 rounded-full w-13 h-13"}>
                                    <img src={user3Image} alt={"user3"} className={"rounded-full w-10 h-10"}/>
                                </div>
                            </div>
            ...
            <div className={"footer w-full flex justify-between items-center bg-gray-700 px-7 py-12"}>
                ...
                <div className={"flex gap-2 items-center"}>
                    <img src={logoBlue} alt={""} className={"w-8"}/>
