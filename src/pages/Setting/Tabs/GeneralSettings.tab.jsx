  ...
  return (
    <div className={"flex md:gap-32 gap-10 w-full md:flex-row flex-col"}>
      <div className={"hidden md:block"}>
        <div
          className={
            "bg-white dark:bg-gray-200 py-3 px-2 w-64 flex flex-col gap-2 rounded-lg "
          }
        >
      ...
      <div
        className={
          "md:p-5 p-2 rounded-2xl bg-white dark:bg-gray-800 lg:w-[39%]"
        }
      >
        ...
        <div className={"hidden md:block"}>
          {activeTab === "regional-preferences" ? (
            <RegionalPreferences />
          ) : (
            <ThemeOptions />
          )}
