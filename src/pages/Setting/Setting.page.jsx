  ...
  return (
    <>
      ...
      >
        <div
          className={
            "flex justify-between md:flex-row flex-col items-center bg-white dark:bg-gray-800 p-4"
          }
        >
          <div className="title-page flex items-center gap-2 bg-none text-start w-full md:py-6 py-3 text-base sm:text-lg md:text-xl text-gray-600">
            <div className={"p-2 rounded-full bg-gray-100 dark:bg-gray-900"}>
              <IoSettingsOutline
                className={
                  "group-hover:text-primary-500 w-[19.62px] h-[19.62px] dark:text-gray-100"
                }
              />
            </div>
            <div>
          ...
          >
            <div className={"flex flex-wrap gap-2 md:w-auto w-full"}>
              <button
                className={
                  "bg-none p-2.5 md:w-48 flex-1 justify-center  rounded-[10px] flex gap-1 items-center dark:text-primary-200 dark:border-primary-200  border border-primary-500 text-primary-500"
                }
              >
                <FiPlus size={20} />
              ...
              <button
                className={
                  "bg-none p-2 md:w-48 flex-1 flex gap-1 justify-center rounded-[10px] items-center border border-primary-500 dark:text-primary-200 dark:border-primary-200 text-primary-500"
                }
              >
                <FiPlus size={20} />
