...
// Blue and white Gemini/Bard-style logo (three stars, right one moved further right)
const GeminiIcon = () => (
  <div className="flex items-center justify-center w-24 h-24 rounded-full relative" style={{ background: "radial-gradient(circle, #4F8CFF 60%, #E3EDFF 100%)" }}>
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="32" cy="32" r="28" fill="#4F8CFF" />
      {/* Large white sparkle - bigger, shifted left */}
      <path d="M27 13l4.5 9 9 4.5-9 4.5-4.5 9-4.5-9-9-4.5 9-4.5 4.5-9z" fill="#fff"/>
      {/* Medium white sparkle - moved further right */}
      <path d="M47 36l2 4 4 2-4 2-2 4-2-4-4-2 4-2 2-4z" fill="#fff"/>
      {/* Small white sparkle - centered below the others */}
    ...
    <div className="absolute w-full h-full rounded-full" style={{
      boxShadow: "0 0 32px 8px #4F8CFF55, 0 0 64px 16px #4F8CFF22"
    }}></div>
  </div>
);
