            ...
            className={`absolute z-100 flex flex-col  mt-2 bg-white dark:bg-white-0 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 ${className}`}>
            {
                states?.map((status,index) => (
                    <button
                        ...
                        className="w-full px-3 py-3 text-sm border-b dark:border-gray-700 dark:text-gray-200 flex gap-2 items-basline text-left text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-900"
                    >
                        {
