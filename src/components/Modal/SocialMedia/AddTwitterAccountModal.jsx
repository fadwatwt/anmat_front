...
function AddTwitterAccountModal({ isOpen, onClose }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            showProcessing("Creating Twitter account...");
            try {
                const payload = {
                ...
                setApiResponse({
                    isOpen: true,
                    status: "success",
                    message: response?.message || "Twitter account created successfully",
                });
            } catch (error) {
                const message =
                    error?.data?.message ||
                    error?.data?.error ||
                    error?.error ||
                    "Failed to create Twitter account";
    ...
    return (
        <>
            <Modal
                ...
                isBtns={true}
                btnApplyTitle={isLoading ? "Saving..." : "Add Account"}
