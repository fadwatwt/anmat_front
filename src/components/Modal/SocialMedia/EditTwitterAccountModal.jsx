...
function EditTwitterAccountModal({ isOpen, onClose, account }) {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            description: Yup.string().max(500, "Too long").nullable(),
            location: Yup.string().nullable(),
            Category: Yup.string().nullable(),
            SecretKey: Yup.string()
                .trim()
                .matches(/^[A-Z2-7\s]*$/i, "2FA secret key uses base32 characters (A–Z, 2–7) only")
                .nullable(),
        }),
    ...
    return (
        <>
            <Modal
                ...
                isBtns={true}
                btnApplyTitle={isLoading ? "Saving..." : "Save Changes"}
                disabled={isLoading}
            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-col gap-1 w-full items-start">
                        <label className="text-cell-primary text-sm font-medium">2FA Secret Key</label>
                        <input
                            type="text"
                            name="SecretKey"
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            placeholder="ABCD EFGH IJKL MNOP (base32 — leave empty if 2FA is disabled)"
                            autoComplete="off"
                            spellCheck={false}
                        ...
                        <p className="text-xs text-cell-secondary">
                            Required only for accounts with two-factor authentication enabled.
                        </p>
                    ...
                    <div className="flex flex-col gap-1 w-full items-start">
                        <label className="text-cell-primary text-sm font-medium">Description</label>
                        <textarea
                            name="description"
