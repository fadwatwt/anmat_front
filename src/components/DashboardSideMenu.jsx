...
const Menu = React.memo(({ isSlidebarOpen, toggleSlidebarOpen }) => {
    ...
    return (
        <div
            className={`fixed md:relative top-0 bottom-0 z-40 flex flex-col w-[272px] max-w-[272px] h-screen bg-white dark:bg-gray-800 border-e dark:border-gray-700 transition-transform duration-300 ease-in-out gap-5
