...
function Menu({isSlidebarOpen,taggleSlidebarOpen}) {
    ...
    // GeminiIcon for sidebar (white/black by default, light blue on hover)
    const GeminiIcon = () => (
        <svg className="gemini-sidebar-icon" width="25" height="25" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Large sparkle */}
            <path d="M27 13l4.5 9 9 4.5-9 4.5-4.5 9-4.5-9-9-4.5 9-4.5 4.5-9z" fill="#fff" stroke="#222" strokeWidth="1.5"/>
            {/* Medium sparkle */}
            <path d="M47 36l2 4 4 2-4 2-2 4-2-4-4-2 4-2 2-4z" fill="#fff" stroke="#222" strokeWidth="1.5"/>
            {/* Small sparkle */}
            <path d="M32 52l1.2 2.4L36 56l-2.4 1.2L32 60l-1.2-2.4L28 56l2.4-1.2L32 52z" fill="#fff" stroke="#222" strokeWidth="1.5"/>
        </svg>
    );
            ...
            <div className={"overflow-y-auto flex flex-col  tab-content justify-between"}>
                ...
                <div className={"flex  flex-col gap-2"}>
                    <div className={"py-5 menu-list sm:py-0 flex flex-col gap-2 text-gray-500"}>
                        ...
                        <MenuItem path={"/assistant"} icon={<GeminiIcon />} title={"AI Assistant"}/>
