        ...
        >
            <div className="flex flex-col gap-4 justify-center items-center p-5">
                ...
                <div className="flex flex-col justify-center items-center">
                    <p className="text-center px-4 text-wrap dark:text-sub-300 text-sub-500 text-lg text-black">
                        {t("Are you sure you want to")}
                        {subFeature && <span className="font-bold"> {subFeature} </span>}
                        {feature && (
                            <>
                                {t("of your")} <span className="font-bold">{feature}</span>
                            </>
                        )}
                        ?
                    </p>
            ...
            {isBtns && (
                <div className="w-full pb-1 pt-3 flex px-5 pb-6 items-center gap-3 border-t dark:border-gray-700">
                    <button
